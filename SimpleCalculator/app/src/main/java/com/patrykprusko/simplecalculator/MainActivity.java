 ...
 * - 16 basic
 * - 4 additional :
 * Application operation: Clear button -> C , Negation button -> NEG , Modulo button -> MOD , Square root button -> √x
 * - basic calculations addition, subtraction, division, multiplication.
 *
 * Additional buttons created:
 * 1. Clear button ( C ) : clears the fields result, newNumber, operations.
